...
#  TODO: Pasar preprocesado a función
...
for i in range(0, 1000):
    ...
    classifier = neural_network.MLPClassifier(hidden_layer_sizes=[6], max_iter=100000, learning_rate_init=0.001)
